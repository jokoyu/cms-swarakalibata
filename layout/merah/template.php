  ...
  <!-- Akhir Script Facebook -->
   ...
   var Tynt=Tynt||[];Tynt.push('accswOR5Kr4yaUacwqm_6r');Tynt.i={"ap":"<br/><b>Sumber Berita: www.swarakalibata.com</b><hr>"};
  ...
  <link rel="stylesheet" href="<?php echo "$f[folder]/css/tabs-1.css" ?>" type="text/css" />
  ...
  <link rel="stylesheet" href="<?php echo "$f[folder]/css/kurs_bca.css" ?>" type="text/css" />
  
  <!-- Bagian JavaScripts/jQuery -->
  <script src="<?php echo "$f[folder]/js/flowplayer-3.2.4.min.js" ?>" type="text/javascript"></script>
  ...
  <script src="<?php echo "$f[folder]/js2/jquery.slidernews.js" ?>" type="text/javascript"></script>
		...
		$(document).ready(function() {
			...
			$("a[rel=example_group]").fancybox({
				...
				'titleFormat'		: function(title, currentArray, currentIndex, currentOpts) {
					return '<span id="fancybox-title-over"><span class style=\"color:#EA1C1C;\">foto ' + (currentIndex + 1) + ' / ' + currentArray.length + (title.length ? ' &nbsp;</span> ' + title : '') + '</span>';
				}
			});
 ...
 <?php
  ...
  echo "
  <li><class='user'>Pengunjung Online: <span class style=\"color:#EA1C1C;\">$pengunjungonline</span> Orang | 
  <class='hits'>Statistik Kunjungan: <span class style=\"color:#EA1C1C;\">$hits[hitstoday]</span> / $totalhits </li>";
  ?>
  <!----------- AKHIR COPYRIGHT  ------------------------>
