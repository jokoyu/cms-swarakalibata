  ...
  echo "<h6>Maaf, anda sudah pernah melakukan pemilihan terhadap jajak pendapat ini.</h6>";}
  else{
  ...
  echo "<h6>Terima kasih atas partisipasi anda mengikuti polling kami</h6><br/></div>";
  
  echo "<h5><class style=\"color:#EA1C1C;\">Hasil Jajak Pendapat saat ini:</h5><br/>";
  ...
  echo "<tr><td width=240><b>$s[pilihan]  <span class style=\"color:#EA1C1C;\">($s[rating])</span></b></td><td> 
